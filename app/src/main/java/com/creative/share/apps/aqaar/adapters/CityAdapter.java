...
import com.creative.share.apps.aqaar.databinding.SpinnerCityRowBinding;
...
public class CityAdapter extends BaseAdapter {
    private List<CityDataModel.CityModel> dataList;
    private Context context;
    private String lang;
    public CityAdapter(List<CityDataModel.CityModel> dataList, Context context) {
